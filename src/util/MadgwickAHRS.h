...
private:
    ...
    float q1,a1;
    float q2,a2;
    float q3,a3;	// quaternion of sensor frame relative to auxiliary frame
    float invSampleFreq;
    float roll;
    float pitch;
    float yaw;
    char anglesComputed;
    void computeAngles();
    char quaternioned; //show quaternion out
    void quaternion(); //show quaternion out
